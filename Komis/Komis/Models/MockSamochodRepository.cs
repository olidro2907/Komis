...
namespace Komis.Models
{
    ...
    {
        // zaiplementowanie metod zaimplementowanych z interface'a

        private List<Samochod> samochody; // lista samochodow
        // zainicjalizowanie listy w konstruktorze jeżeli jest pusta
        ...
        private void ZaladujSamochody() // inicjalizowanie listy z pewnymi zakodowanymi danymi
        {
            samochody = new List<Samochod>
            {
                ...
                new Samochod {Id=6, Marka="Jaguar", Model="ZX", RokProdukcji=2006, Przebieg= "78 000 km", Pojemnosc="5 000 cm3", RodzajPaliwa="benzyna", Moc="510 KM",Opis= "Przedstawiam Państwu wyjatkowe auto jakim jest Jaguar XKR, a zwłaszcza ten egzemplarz. Jaguar XKR to ikona światowej i brytyjskiej motoryzacji, a przede wszystkim kontynuator legendarnego już Jaguara E-typa, przez wielu uważany za najpiekniejsze auto w historii motoryzacji.", Cena=200000M, ZdjecieUrl="/images/jaguar.jpg", MiniaturkaUrl="/images/jaguar.jpg", JestSamochodemTygodnia=true }
